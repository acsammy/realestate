class EstatesController < ApplicationController
  ...
  private
    ...
    def estate_params
      params.require(:estate).permit(:kind_id, :street, :number, :neighborhood, :city, :rooms, :total_construction, :total_area, :description, :price, :image0, :image1, :image2, :image3, :image4, :image5, :name, :map)
    end
end
